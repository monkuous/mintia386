...
const PTE_POOL_SINGLETON  2
const PTE_POOL_INFO_SHIFT 12
const PTE_POOL_INFO_MASK  0xFFFFF

const PTE_PAGEFILE_SHIFT 5
const PTE_PAGEFILE_MASK  15

const PTE_SWAPPAGE_SHIFT 12
const PTE_SWAPPAGE_MASK  0xFFFFF
...
const PTE_KERNEL_ZERO 16
const PTE_KERNEL_DEMANDZERO 24

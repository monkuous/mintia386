...
const XLOFF_MAGIC 0xAA584F46

const XLOFF_ARCHITECTURE_XR17032 1
const XLOFF_ARCHITECTURE_FOX32   2
const XLOFF_ARCHITECTURE_I386    0x36383369

#ifdef XR17032

const XLOFF_ARCHITECTURE XLOFF_ARCHITECTURE_XR17032

const XLOFF_RELOC_XR17032_LONG     1
const XLOFF_RELOC_XR17032_ABSJ     2
const XLOFF_RELOC_XR17032_LA       3
const XLOFF_RELOC_XR17032_FAR_INT  4
const XLOFF_RELOC_XR17032_FAR_LONG 5
const XLOFF_RELOC_XR17032_HI16     6
const XLOFF_RELOC_XR17032_LO16     7
const XLOFF_RELOC_XR17032_LO16_1   8
const XLOFF_RELOC_XR17032_LO16_2   9

#endif

#ifdef FOX32

const XLOFF_ARCHITECTURE XLOFF_ARCHITECTURE_FOX32

const XLOFF_RELOC_FOX32_LONG 1
const XLOFF_RELOC_FOX32_SRC  2
const XLOFF_RELOC_FOX32_DEST 3
const XLOFF_RELOC_FOX32_JMP  4
const XLOFF_RELOC_FOX32_MDST 5
const XLOFF_RELOC_FOX32_LDST 6

#endif

#ifdef I386

const XLOFF_ARCHITECTURE XLOFF_ARCHITECTURE_I386

const XLOFF_RELOC_I386_32    1
const XLOFF_RELOC_I386_PC32  2
const XLOFF_RELOC_I386_PLT32 3
const XLOFF_RELOC_I386_16   20
...
const XLOFF_SECTIONFLAG_DEFERREDFREE 32
